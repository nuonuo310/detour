(()=>{
 ...
 const sync=()=>{stop();if(host.classList.contains('is-ready')&&!document.hidden&&!reduced.matches)raf=requestAnimationFrame(tick)};
 ...
 document.documentElement.classList.add('detour-read-day-v2');
})();
